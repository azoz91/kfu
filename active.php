...
{
$sql="UPDATE student SET status='active' WHERE ID IN (".$_POST['stdid[]'].")";
...
header("Location: active.php?status=$status");
}
		?>
		<div class="body">
				<div>
    ...
    <?php } else { ?>
					<form id="activate" name="activate" method="POST" action="active.php">
        ...
        </td><td><input type='checkbox' name='stdid[]' value=".$row["ID"]."/> 
        </td></tr>";}?>
	</table>
	</br>
